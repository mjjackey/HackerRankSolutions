...
def plusMinus(arr):
    ...
    arrPosi = [num for num in arr if num > 0]
    arrNega = [num for num in arr if num < 0]
    arrZero = [num for num in arr if num == 0]
    occPosi = round(len(arrPosi) / len(arr), 6)
    occNega = round(len(arrNega) / len(arr), 6)
    occZero = round(len(arrZero) / len(arr), 6)
    print(occPosi)
    print(occNega)
    print(occZero)
